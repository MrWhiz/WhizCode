  ...
  return (
    <div className="activity-bar">
      ...
      >
        ...
        >
          <path
            d="M12 2v8M6.29 12.29l1.42 1.42M17.71 12.29l-1.42 1.42M2 12h8M14 12h8M6.29 11.71l1.42-1.42M17.71 11.71l-1.42-1.42"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
      ...
      <div
        ...
        onClick={() =>
          setActiveView(activeView === "preview" ? null : "preview")
        }
        title="Live Preview"
      >
        <svg
      ...
      <div
        className={`activity-item ${activeView === "skills" ? "active" : ""}`}
        onClick={() => setActiveView(activeView === "skills" ? null : "skills")}
        title="Skills"
      >
        <svg
          width="24"
